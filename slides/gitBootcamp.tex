...
% Setting up Git
\begin{frame}
	\frametitle{\textbf{Level One: Setting up Git}}
...
\begin{frame}
	\frametitle{\textbf{Level One: Command-line Text Editors}}
...
% Nano Text Editor 
\begin{frame}
	\frametitle{\textbf{Level One: GNU Nano Text Editor}}
...
% Vim Text Editor 
\begin{frame}
	\frametitle{\textbf{Level One: Vim Text Editor}}
...
% Emacs Text Editor 
\begin{frame}
	\frametitle{\textbf{Level One: Emacs Text Editor}}
...
\begin{frame}
	\frametitle{\textbf{Level One: What makes a good commit?}}
...
\begin{frame} 
	...
	\begin{itemize}
		\item \textit{Subject:} Add a subject title
		\vspace{0.5cm}
...
% Making a Commit 
\begin{frame}
	\frametitle{\textbf{Level One: Making a commit}}
	
	\textbf{Step 1.} \textit{Initializes a new repository in the current directory}
	\begin{itemize}
		\item git init
	\end{itemize}
	\vspace{0.25cm}

	\textbf{Step 2.} \textit{Add a document to staging}
	\begin{itemize}
		\item git add \(\prec document \succ\)
	\end{itemize}
	\vspace{0.25cm}

	\textbf{Step 3.} \textit{View documents that have been staged (Optional)}
	\begin{itemize}
		\item git status
	\end{itemize}
	\vspace{0.25cm}

	\textbf{Step 4.} \textit{Remove a document from staging (Optional)}
	\begin{itemize}
		\item git reset \(\prec document \succ\)
	\end{itemize}
	\vspace{0.25cm}

	\textbf{Step 5.} \textit{Record changes to repository}
	\begin{itemize}
		\item git commit
	\end{itemize}
	\vspace{0.25cm}

	\textbf{Step 6.} \textit{Upload changes to remote repository}
	\begin{itemize}
		\item git push 
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\textbf{Task 1:}
	\begin{itemize}
	\item Setup a second git profile include your name, email, editor of choice 
	\end{itemize}
...
\begin{frame}
	\frametitle{\textbf{Level Two: Remote Version Control Platforms}}
...
% GitHub 
\begin{frame}
	\frametitle{\textbf{Level Two: GitHub}}
...
% Gitlab
\begin{frame}
	\frametitle{\textbf{Level Two: GitLab}}
	...
	\begin{multicols}{2}
		...
		\begin{itemize}
			...
			\item One of the only platform that self-hosting is free, also checkout gitea
		\end{itemize}
...
\begin{frame}
	\frametitle{\textbf{Level Two: Introduction to OpenSSH Suite}}
...
% Create an SSH Key
\begin{frame}
	\frametitle{\textbf{Level Two: Generate an SSH Key}}
...
\begin{frame}
	\frametitle{\textbf{Level Two: Adding an SSH Key to the SSH-Agent}}
...
% login into gitlab 
\begin{frame}
	\frametitle{\textbf{Level Two: Exploring GitLab}}
...
\begin{frame}
	\frametitle{\textbf{Level Two: Adding our key to GitLab}}
...
\begin{frame}
	\frametitle{\textbf{Level Two: Testing our connection}}
	...
	\begin{block}{\textbf{Troubleshooting Steps}}
		\begin{itemize}
			...
			\item \textit{Re-check your test command is correct}
		\end{itemize}
	\end{block}
...
\begin{frame}
	\frametitle{\textbf{Level Two: Git Remote Repository Commands}}
...
\begin{frame}
	\frametitle{\textbf{Level Two: What is Git Branching?}}

	\begin{itemize}
		\item Allows you make an isolated copy of your work 
		\item Protects yourself from messing up your main branch 
	\end{itemize}
	\vspace{0.25cm}
...
% Making a git branch 
\begin{frame}
	\frametitle{\textbf{Level Two: Making a Git Branch}}
	...
	\begin{itemize}
		\item \textit{Moves you to the specified branch}
	\end{itemize}
	\vspace{0.25cm}
...
\begin{frame}
	...
	\textbf{Task 2:}
	\begin{itemize}
	\item Create a repository called LevelTwo
	\item Clone the LevelTwo repo and make a commit
	\end{itemize}
...
\begin{frame}
	...
	\begin{block}{\textbf{Remotes}}
Remotes are references to a repository that are typically stored on a remote
server. 
	\end{block}
\end{frame}
...
% rolling back in git 
\begin{frame}
	\frametitle{\textbf{Level Three: Git Rollbacks}}
...
% git stash 
\begin{frame}
	\frametitle{\textbf{Level Three: Git Stashing}}
...
\begin{frame}
	\frametitle{\textbf{Level Three: Additional Learning Resources}}
...
% git game
\begin{frame}
	\frametitle{\textbf{Level Three: The fun continues}}
	
	\hspace{1cm}\textbf{Lets play a game}

	\begin{multicols}{2}
	\begin{figure}[h]
	\flushright
	\includegraphics[width=0.5\textwidth]{img/gitGame.png} 
	\end{figure}
	\vspace{0.25cm}
	\begin{itemize}
	\item Navigate to the git bootcamp repository gitlab.com/natedolny/gitbootcamp
	\vspace{0.25cm}
	\item Click on the Games directory 
	\vspace{0.25cm}
	\item Download the oh-my-git game 
	\vspace{0.25cm}
	\item Let the fun begin!!
	\end{itemize}
	\end{multicols}
\end{frame}
\end{document}
