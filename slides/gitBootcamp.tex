...
\begin{frame}
	...
	Vim Website: \textit{www.vim.org}

	Vim Tutorial: \textit{www.vim-hero.com}

	Vim Manual: \textit{man vim (if on a unix based machine)}
	
	\vspace{0.25cm}
	Nano Website: \textit{www.nano-editor.org}
	...
	Git Website: \textit{git-scm.com}

	Git Manual: \textit{git-scm.com/doc}
 
	\vspace{0.25cm}
	GitHub Website: \textit{www.github.com}

	GitHub Manuals: \textit{https://docs.github.com/en}

	\vspace{0.25cm}
	GitLab Website: \textit{www.gitlab.com}

	GitLab Manuals: \textit{ttps://docs.gitlab.com/ee/}
\end{frame}
\end{document}
